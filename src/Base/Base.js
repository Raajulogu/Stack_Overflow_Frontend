    ...
    <span className='head-option-nav'>
      ...
      <Menu
            ...
            >
              ...
              <MenuItem onClick={handleCloseUserMenu}>
                <Typography textAlign="center" onClick={()=>navigate("/company")}>
              ...
              {!localStorage.getItem('token')&&
                <MenuItem onClick={handleCloseUserMenu}>
                  <Typography textAlign="center" onClick={()=>navigate("/signup")}>
                  Signup</Typography>
                </MenuItem>
              }
              {localStorage.getItem("token") &&
                <MenuItem onClick={handleCloseUserMenu}>
                  <Typography textAlign="center" onClick={handleLogut}>
                  Logout</Typography>
                </MenuItem>
              }
